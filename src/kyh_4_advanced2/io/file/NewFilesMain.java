package kyh_4_advanced2.io.file;

import java.io.IOException;
import java.nio.file.*;
import java.nio.file.attribute.BasicFileAttributes;

// Files, Path 클래스는 File 클래스를 대체한다.
// Files 클래스는 직접 인스턴스를 생성할 수 없고, static 메서드로 기능을 제공한다.
...
//        System.out.println("File deleted");
        ...
        System.out.println("Issymbolic link: " + attrs.isSymbolicLink());
