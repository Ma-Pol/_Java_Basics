...
import kyh_4_advanced2.was.httpserver.servlet.InternalErrorServlet;
import kyh_4_advanced2.was.httpserver.servlet.NotFoundServlet;
...
public class ServletManager {
    ...
    private HttpServlet notFoundErrorServelt = new NotFoundServlet();
    ...
    public void setNotFoundErrorServlet(HttpServlet notFoundErrorServelt) {
        this.notFoundErrorServelt = notFoundErrorServelt;
    }
    ...
    public void execute(HttpRequest request, HttpResponse response) throws IOException {
        try {
            ...
            e.printStackTrace();
            notFoundErrorServelt.service(request, response);
        } catch (Exception e) {
            e.printStackTrace();
